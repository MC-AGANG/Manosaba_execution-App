...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "org.agang.execution", "org.agang.execution.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "org.agang.execution.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
